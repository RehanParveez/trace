...
import {useDeleteRole, useRoles,
} from "../hooks";
import type {Role,
} from "../types/organization.types";
import {RoleTable,
} from "../components/RoleTable";
import {Button, ErrorState, Icon, Modal, PageHeader, Panel, PanelHeader, StatCard,
      ...
      <div className="space-y-5">
        ...
        <Panel>
          ...
          <RoleTable
            ...
            onView={(role) =>
              navigate(
                `/app/organization/roles/${role.id}`,
              )
            }
            onDelete={
              setDeletingRole
